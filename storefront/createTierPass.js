...
import { tierId } from '../modules/hotlineModule.js';
...
export default function () {
  ...
  const postData = JSON.stringify({
    query: `mutation createTierPass($quantity:Float!, $tierId: String!, $tierPrice:Float! ) {
      createTierPass(
        data: { duration: Daily, quantity: $quantity, tierId: $tierId, tierPrice: $tierPrice }
      ) {
        message
        status
      }
    ...
    variables: {
      ...
      tierPrice: randomIntBetween(1, 500),
    },
  });
